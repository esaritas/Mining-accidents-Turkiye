<!-- Selection criterion: machinery or transport event. This slot is EMPTY by design: no incident is named. Populating it requires collected source documents (see data/review_packets/README.md). -->

# Review packet — PILOT-11 (empty slot — criterion: machinery or transport event)
...
_To be selected: an incident matching the criterion above._
...
_No claims extracted yet._

## 4. Conflicts

_Not applicable until claims exist._
