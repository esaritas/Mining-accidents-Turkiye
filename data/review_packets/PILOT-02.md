<!-- Selection criterion: small casualty count. This slot is EMPTY by design: no incident is named. Populating it requires collected source documents (see data/review_packets/README.md). -->

# Review packet — PILOT-02 (empty slot — criterion: small casualty count)
