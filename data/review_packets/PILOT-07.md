<!-- Selection criterion: informal/illegal operation. This slot is EMPTY by design: no incident is named. Populating it requires collected source documents (see data/review_packets/README.md). -->

# Review packet — PILOT-07 (empty slot — criterion: informal/illegal operation)
