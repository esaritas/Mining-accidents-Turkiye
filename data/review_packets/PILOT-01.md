<!-- Selection criterion: large casualty count. This slot is EMPTY by design: no incident is named. Populating it requires collected source documents (see data/review_packets/README.md). -->

# Review packet — PILOT-01 (empty slot — criterion: large casualty count)
