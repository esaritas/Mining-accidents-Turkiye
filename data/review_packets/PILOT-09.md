<!-- Selection criterion: collapse event. This slot is EMPTY by design: no incident is named. Populating it requires collected source documents (see data/review_packets/README.md). -->

# Review packet — PILOT-09 (empty slot — criterion: collapse event)
