<!-- Selection criterion: conflicting local sources. This slot is EMPTY by design: no incident is named. Populating it requires collected source documents (see data/review_packets/README.md). -->

# Review packet — PILOT-12 (empty slot — criterion: conflicting local sources)
